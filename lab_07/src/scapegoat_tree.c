...
int scapegoat_create_node(scapegoat_node_t *root, scapegoat_node_t **node, char elem)
{
...
int scapegoat_add(scapegoat_node_t **root, char elem, size_t *cnt, int balance)
{
    int rc = 0;
...
void scapegoat_del(scapegoat_node_t **root, char elem)
{
    if ((*root) == NULL)
        return;
...
scapegoat_node_t **scapegoat_find(scapegoat_node_t **root, char elem)
{
...
int scapegoat_scan_from(scapegoat_tree_t *tree, my_string_t s)
{
    int rc = 0;
